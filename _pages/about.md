...
I am a first-year PhD candidate at the [HKUST NLP Group](https://hkust-nlp.github.io/), Hong Kong University of Science and Technology, supervised by Prof. Junxian He. I received my B.Eng. from Shanghai Jiao Tong University in June 2024. My research focuses on natural language processing and machine learning.
...
Publications
======
(* denotes first author; my name is shown in **bold**)
...
2. **On the Perception Bottleneck of VLMs for Chart Understanding**
   ...
   *arXiv*, 2025. (First author) Code available on GitHub (Vision4Chart).

3. **On the Universal Truthfulness Hyperplane Inside LLMs**

   **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He

   *EMNLP 2024*. (First author) Code available on GitHub (Universal_Truthfulness_Hyperplane).
